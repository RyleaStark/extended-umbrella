...
| [Fulcrum (LTC)](https://github.com/RyleaStark/umbrel-litecoin-fulcrum-gui) | `extended-umbrella-litecoin-fulcrum` | `2.1.1-umbrel.10` | `12109` | Alternative high-performance Electrum provider; wallet port `51002` |
