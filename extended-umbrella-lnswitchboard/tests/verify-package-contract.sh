...
APP_IMAGE='ghcr.io/ryleastark/lnswitchboard:0.4.0.rc32@sha256:20f268d81cac7006653af38c801502b5a5daafa2844593f8096a0803c700d8c6'
...
assert manifest['version'] == '0.4.0.rc32-umbrel.1'
assert 'version' not in compose
app = compose['services']['lnswitchboard']
assert app['image'] == 'ghcr.io/ryleastark/lnswitchboard:0.4.0.rc32@sha256:20f268d81cac7006653af38c801502b5a5daafa2844593f8096a0803c700d8c6'
...
[ "$app_revision" = '0cb59445a4d1cd6c2e9430e901cec58a2a5f7906' ]
echo 'GREEN exact_rc32_source_revision_ok'
